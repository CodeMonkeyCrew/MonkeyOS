...
#define GPTIMER1    (uint32_t*) 0x48318000
#define GPTIMER_GENERAL_BASE (uint32_t*) 0x49032000
#define GPTIMER2    (uint32_t*) 0x49032000
#define GPTIMER3    (uint32_t*) 0x49034000
#define GPTIMER4    (uint32_t*) 0x49036000
#define GPTIMER5    (uint32_t*) 0x49038000
#define GPTIMER6    (uint32_t*) 0x4903A000
#define GPTIMER7    (uint32_t*) 0x4903C000
#define GPTIMER8    (uint32_t*) 0x4903E000
#define GPTIMER9    (uint32_t*) 0x49040000
#define GPTIMER10   (uint32_t*) 0x48086000
#define GPTIMER11   (uint32_t*) 0x48088000
